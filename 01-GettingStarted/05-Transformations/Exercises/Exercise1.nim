...
# around by first rotating and then translating. See what happens and try to
...
proc setup() =
  shaderProgram = createShaderProgramFromFile("exercise1.vs",
                                              "exercise1.fs")
...
proc main() =
  ...
  cfg.title = "05-Transformations/Exercise1"
  cfg.resizable = false
